...
C'est :
  ...
  * Libre et gratuit, sous licence GNU GPL v3. Le code source est accessible [ici](https://code.google.com/p/cmathluatex/source/browse/trunk/CmathLuaTeX.lua). L'onglet [Issues](https://code.google.com/p/cmathluatex/issues/list) de cette page permet de remonter des bogues, de proposer des améliorations, etc...
